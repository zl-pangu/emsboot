...
; !
    function(a) {
        var b = {
                ...
                qsEnabledM:false,
                quickSelM:[],
                onlyHour:false, //是否只显示小时与istime连用,
                isConnect:false,//是否前后时间联动
                connId:[]//时间联动的时候把时间id放入
            },
            c = {},
            d = document,
            e = "createElement",
        ...
        a.laydate = function(b) {
            ...
            try {
                ...
                h.isConnect=b.isConnect,h.connId=b.connId;
            } catch(d) {}
            return c.run(b),
                laydate
        },
                ...
                a > (0 | c.maxs[0]) && (a = 0 | c.maxs[0]),
                    ...
                    c.each(new Array(3),
                        function(a) {
                            ...
                            if (c.options.qsEnabledH&&a==0){
                                c.hmsin[a].value = 0 | f.times[a]==0?c.options.quickSelH[0]:c.digit(0 | f.times[a]);
                            }
                            if (c.options.qsEnabledM&&a==1){
                                c.hmsin[a].value = 0 | f.times[a]==0?c.options.quickSelM[0]:c.digit(0 | f.times[a]);
                            }
                        }),
            ...
            c.view = function(a, f) {
                ...
                c.options.qsEnabledH || (c.options.qsEnabledH = b.qsEnabledH),
                c.options.qsEnabledM || (c.options.qsEnabledM = b.qsEnabledM),
                c.options.quickSelH || (c.options.quickSelH = b.quickSelH),
                c.options.quickSelM || (c.options.quickSelM = b.quickSelM),
                c.options.onlyHour || (c.options.onlyHour = b.onlyHour),
            ...
            c.events = function() {
                ...
                c.addClass(d.body, "laydate_body"),
                    ...
                    c.on(h.oclear, "click",
                        function() {
                            if (h.isConnect){
                                if (c.elem["id"]==h.connId[0]){
                                    endDate.min='';
                                    endDate.start='';
                                }else if(c.elem["id"]==h.connId[1]){
                                    startDate.max='';
                                }
                            }
                            c.elem[h.elemv] = "",
                    ...
                    c.msg = function(a, d) {
                    	e.hmsarr = [];
                        var _isH = a==0?true:false;
                        var f = '<div class="laydte_hsmtex">' + (d || "提示") + "<span>×</span></div>";
                        "string" == typeof a ? (f += "<p>" + a + "</p>", c.shde(b("#" + h[0])), c.removeClass(e.times, "laydate_time1").addClass(e.times, "laydate_msg")) : (e.hmsarr[a] ? f = e.hmsarr[a] : (f += '<div id="laydate_hmsno" class="laydate_hmsno">', c.each(0 === a ? (c.options.qsEnabledH?c.options.quickSelH:new Array(24)) : (a==1&&c.options.qsEnabledM?c.options.quickSelM:new Array(60)),
                            function(a) {
                                f += "<span>" + (_isH?(c.options.qsEnabledH?c.options.quickSelH[a]:a):(c.options.qsEnabledM?c.options.quickSelM[a]:a)) + "</span>"
                    ...
                    e.hmson = function(a, d) {
                        ...
                        if (c.options.qsEnabledH){
                            var _span;
                            $.each(e,function () {
                                if (a.value==$(this)[0].innerHTML){
                                    _span = this;
                                }
                            });
                            c.addClass(_span, "laydate_click");
                        }else {
